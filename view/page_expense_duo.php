...
<tr>
  <td style="vertical-align: middle;">
	  ...
	  <br/><br/>
  	  <?= $translator->getTranslation('Depuis le compte') ?> <input type="radio" name="fromAccount" value="duo" <?php if (true) echo 'checked'; ?>><?= $translator->getTranslation('commun') ?> </input><?= $translator->getTranslation('ou') ?> <input type="radio" name="fromAccount" value="private" <?php if (false) echo 'checked'; ?>><?= $translator->getTranslation('privé') ?></input>
  	  <br/>
  	  <input type="radio" name="privateAccount" checked value=""><i>non défini</i><br />
  	  <?php
...
<tr>
	<td colspan=4><b><i>Catégories duo</i></b></td>
</tr>
<?php
$categories = $activeAccount->GetAccountCategoriesForOutcome();
$i = 1;
while ($row = $categories->fetch())
{
	...
	<td align="center">
	<input type="text" name="category<?php echo $i; ?>ChargeLevel" value="50" size="2"> %
	</td>
	</tr>
	<?php
	}
...
?>
<tr>
	<td colspan=4><b><i>Catégories privées</i></b></td>
</tr>
	<?php
...
while ($row = $categories->fetch())
{
	...
	<td align="center">
	<input type="text" name="category<?php echo $i; ?>ChargeLevel" value="100" size="2"> %
	</td>
	</tr>
	<?php
	}

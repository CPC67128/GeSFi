...
$result = $recordsHandler->GetAllRecordsOfCategory(12 * 5, '0a921b98-edc7-11e3-859c-001132154e39', '8965fe60-18de-11e4-b1a2-001132154e39');
$now = date('Y-m-d');
...
function AddTitleRow()
{
	...
	<td><?= $translator->getTranslation('Sécurité sociale') ?></td>
	<td><?= $translator->getTranslation('Mutuelle Homme') ?></td>
	<td><?= $translator->getTranslation('Mutuelle Femme') ?></td>
	</tr>
	<?php
}
...
function PrintMonitoringFlags($row)
{
	...
	{
		?>
		<td style="text-align: center;"><input type="checkbox" <?= $row['flag_1'] == 1 ? 'checked' : '' ?> onclick="FlagRecord('<?= $row['record_id'] ?>', this, 1);"></td>
		<td style="text-align: center;"><input type="checkbox" <?= $row['flag_2'] == 1 ? 'checked' : '' ?> onclick="FlagRecord('<?= $row['record_id'] ?>', this, 2);"></td>
		<td style="text-align: center;"><input type="checkbox" <?= $row['flag_3'] == 1 ? 'checked' : '' ?> onclick="FlagRecord('<?= $row['record_id'] ?>', this, 3);"></td>
		<?php
	}
}

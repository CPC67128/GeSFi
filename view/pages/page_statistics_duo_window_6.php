...
?>
<h1><?= $translator->getTranslation('Tableau de bord duo, revenus sur 6 mois glissants') ?></h1>
...
$dateStart = new DateTime(date("Y-m-d", strtotime($dateEnd->format("Y-m-d") . " -6 months")));
?>
<h1><?= $translator->getTranslation('Tableau de bord duo, dépenses sur 6 mois glissants') ?></h1>
<table id="recordsTable">
<tbody>
<tr class="tableRowTitle">

<h1><?= $translator->getTranslation('Tableau de bord privé, revenus sur 3 mois glissants') ?></h1>
...
<h1><?= $translator->getTranslation('Tableau de bord privé, dépenses sur 3 mois glissants') ?></h1>
<table class="statsTable">
<tbody>
<tr class="statsTableRowTitle">
